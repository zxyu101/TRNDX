...
local url,res = http.request('http://TRND.ml/joinch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TRND ~= true then
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_TRND, nil)
return false
end
------------------------------------------------------------------------
...
if text == (database:get(bot_id.."TRND:Name:Bot") or "تشاكي") then
Namebot = (database:get(bot_id.."TRND:Name:Bot") or "تشاكي")
local namebot = {
...
download_to_file('https://raw.githubusercontent.com/TRNDabas/TRND/master/TRND.lua', 'TRND.lua') 
download_to_file('https://raw.githubusercontent.com/TRNDabas/TRND/master/start.lua', 'start.lua') 
dofile('TRND.lua')  
return false
end
...
if DevTRND(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TRNDabas/files_TRND/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TRNDabas/files_TRND/master/files_TRND/"..file)
if res == 200 then
...
📋┇ [TRND Dev](https://t.me/TRNDTEAM)

📁┇ [Source  Files](https://t.me/TRND_info)

🌐┇ [TRND iNDT](https://t.me/ZX_XX/4611)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS TRND](https://t.me/A_5bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."TRND:Name:Bot") or "تشاكي")
