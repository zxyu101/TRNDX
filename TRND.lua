...
os.execute('wget https://raw.githubusercontent.com/TRNDX/TRNDX/master/TRND.lua')
os.execute('wget https://raw.githubusercontent.com/TRNDX/TRNDX/master/start.lua')
dofile('TRND.lua')  
return false
end
...
if DevTRND(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TRNDX/FII/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TRNDX/FII/master/Files_TRND/"..file)
if res == 200 then
