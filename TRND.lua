...
local url,res = http.request('https://hswny-bb.ml/sn.php/?id='..msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_,"📝 ‡  ارسل الكلمة التي تريد إضافتها")
...
if text == "بوت" then
Namebot = (database:get(bot_id.."TRND:Name:Bot") or "ترند")
send(msg.chat_id_, msg.id_,"اسمي ["..Namebot.."] حبي🙁 ؟")
end
...
os.execute('wget https://raw.githubusercontent.com/TRNDX/TRND/master/TRND.lua')
os.execute('wget https://raw.githubusercontent.com/TRNDX/TRND/master/start.lua')
dofile('TRND.lua')  
return false
end
...
[🗂 ‡  Source files](https://t.me/TrndFiles)

[📊 ‡ To install](https://t.me/TrndFiles)
...
local keyboard = {
{'✔تفعيل التواصل','✖️تعطيل التواصل'},
{'⭕️تفعيل خدمي','🚫تعطيل خدمي'},
{'اذاعه خاص 🗣️','اذاعه 📡'},
{'💠مسح الوهمي بالخاص', '♦️مسح الوهمي كروبات'},
{'📣الاحصائيات'},
...
if text == "💠مسح الوهمي بالخاص" then
local pv = database:smembers(bot_id..'TRND:UsersBot')  
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]},function(arg,dataq)
...
if text == "♦️مسح الوهمي كروبات" then
local group = database:smembers(bot_id..'TRND:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
if text == '⭕️تفعيل خدمي' then
database:del(bot_id..'TRND:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'\n📫 ‡  تم تفعيل البوت الخدمي ') 
end
if text == '🚫تعطيل خدمي' then
database:set(bot_id..'TRND:Free:Add:Bots',true) 
